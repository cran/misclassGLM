cfgaussValidation <- function(par, Y, X, W, SetM) .Call("cfgaussValidation", par, Y, X, W, SetM)
cggaussValidation <- function(par, Y, X, W, SetM) .Call("cggaussValidation", par, Y, X, W, SetM)
cflogitValidation <- function(par, Y, X, W, SetM) .Call("cflogitValidation", par, Y, X, W, SetM)
cglogitValidation <- function(par, Y, X, W, SetM) .Call("cglogitValidation", par, Y, X, W, SetM)
